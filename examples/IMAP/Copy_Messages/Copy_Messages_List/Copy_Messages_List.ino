...
void setup()
{
    ...
    /* Copy all messages using message sequence ranges (last 10 message numbers) to the folder "test2"*/
    ...
    if (imap.copyMessages(sequence_set2, false /* if sequence set are message numbers not UIDs */, F("test2")))
