...
#include "ESP8266_CertStoreBearSSL.h"
...
//#define DEBUG_ESP_PORT Serial
  ...
  class ESP8266_WCS : public WiFiClient
  {
  public:
    ESP8266_WCS();
    ESP8266_WCS(const ESP8266_WCS &rhs);
    ~ESP8266_WCS() override;

    ESP8266_WCS& operator=(const ESP8266_WCS&) = default; // The shared-ptrs handle themselves automatically
    ...
    void setTrustAnchors(const ESP8266_X509_List *ta) {
      _clearAuthenticationSettings();
      _ta = ta;
    }
    ...
    void setClientRSACert(const ESP8266_X509_List *cert, const PrivateKey *sk);
    void setClientECCert(const ESP8266_X509_List *cert, const PrivateKey *sk,
    ...
    void setCertStore(ESP8266_CertStore *certStore) {
...
#pragma GCC diagnostic pop
  ...
  private:
    ...
    time_t _now;
    const ESP8266_X509_List *_ta;
    ESP8266_CertStore *_certStore;
    int _iobuf_in_size;
    int _iobuf_out_size;
    ...
    std::shared_ptr<ESP8266_X509_List>   _axtls_ta;
    std::shared_ptr<ESP8266_X509_List>   _axtls_chain;
    ...
    const ESP8266_X509_List *_chain;
    ...
    ESP8266_WCS(ClientContext *client, const ESP8266_X509_List *chain, unsigned cert_issuer_key_type, const PrivateKey *sk, int iobuf_in_size, int iobuf_out_size, const ESP8266_X509_List *client_CA_ta);
    ESP8266_WCS(ClientContext* client, const ESP8266_X509_List *chain, const PrivateKey *sk, int iobuf_in_size, int iobuf_out_size, const ESP8266_X509_List *client_CA_ta);

    // RSA keyed server
    bool _connectSSLServerRSA(const ESP8266_X509_List *chain, const PrivateKey *sk, const ESP8266_X509_List *client_CA_ta);
    // EC keyed server
    bool _connectSSLServerEC(const ESP8266_X509_List *chain, unsigned cert_issuer_key_type, const PrivateKey *sk, const ESP8266_X509_List *client_CA_ta);

    // X.509 validators differ from server to client
    bool _installClientX509Validator(); // Set up X509 validator for a client conn.
    bool _installServerX509Validator(const ESP8266_X509_List *client_CA_ta); // Setup X509 client cert validation, if supplied
