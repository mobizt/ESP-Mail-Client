...
#ifndef ESP8266_BearSSLHelpers_H
#define ESP8266_BearSSLHelpers_H
...
namespace ESP8266_TCP
{
  ...
  private:
    esp8266_br_ssl::public_key *_key;
  };
  ...
  private:
    esp8266_br_ssl::private_key *_key;
  };
  ...
  // All inputs can be either in RAM or PROGMEM.
  class ESP8266_X509_List
  {
  public:
    ESP8266_X509_List();
    ESP8266_X509_List(const char *pemCert);
    ESP8266_X509_List(const uint8_t *derCert, size_t derLen);
    ~ESP8266_X509_List();
    ...
    // Disable the copy constructor, we're pointer based
    ESP8266_X509_List(const ESP8266_X509_List &that) = delete;
...
#endif /* ESP8266_BearSSLHelpers_H */
